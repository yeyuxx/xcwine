                                  ...
                                  UINT bpp, const void *bits )
{
    ...
    {
        ERR("(XcSpaceERR)-(dlls-win32u-bitmap.c-NtGdiCreateBitmap)-(code2)\n");
    ...
    if (!width || !height)
    {
        ERR("(XcSpaceERR)-(dlls-win32u-bitmap.c-NtGdiCreateBitmap)-(code3)\n");
        return 0;
    }

    if (height < 0)
    {
        ERR("(XcSpaceERR)-(dlls-win32u-bitmap.c-NtGdiCreateBitmap)-(code4)\n");
        height = -height;
    }
    if (width < 0)
        width = -width;
    ...
    if (planes != 1)
    {
        ERR("(XcSpaceERR)-(dlls-win32u-bitmap.c-NtGdiCreateBitmap)-(code5)\n");
        FIXME("planes = %d\n", planes);
        RtlSetLastWin32Error( ERROR_INVALID_PARAMETER );
        return NULL;
    }
    ...
    {
        ERR("(XcSpaceERR)-(dlls-win32u-bitmap.c-NtGdiCreateBitmap)-(code6)\n");
    ...
    {
        ERR("(XcSpaceERR)-(dlls-win32u-bitmap.c-NtGdiCreateBitmap)-(code7)\n");
        RtlSetLastWin32Error( ERROR_INVALID_PARAMETER );
        return 0;
    }
    ...
    {
        ERR("(XcSpaceERR)-(dlls-win32u-bitmap.c-NtGdiCreateBitmap)-(code8)\n");
    ...
    {
        ERR("(XcSpaceERR)-(dlls-win32u-bitmap.c-NtGdiCreateBitmap)-(code9)\n");
        free( bmpobj );
        RtlSetLastWin32Error( ERROR_NOT_ENOUGH_MEMORY );
        return 0;
    }
    ...
    {
        ERR("(XcSpaceERR)-(dlls-win32u-bitmap.c-NtGdiCreateBitmap)-(code10)\n");
